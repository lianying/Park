...
namespace Park.Entitys.Box
{
    ...
    /// 
    /// </summary>
    public class CarErrorRecord: Entity<long>, IHasCreationTime, IModificationAudited, IHasModificationTime, IDeletionAudited, IHasDeletionTime, ISoftDelete, ISynchronize
    {
