...
namespace Park
{
    public class DelayAction
    {
        ...
        public void Debounce(int timeMs, SynchronizationContext invoker, Action action)
        {
            lock (this)
            {
                if (_timerDbc == null)
        ...
        public void Throttle(int timeMs, SynchronizationContext invoker, Action action)
        {
        ...
        /// 延迟timesMs后执行。 
        /// </summary>
        public void Delay(int timeMs, SynchronizationContext invoker, Action action)
        {
            Debounce(timeMs, invoker, action);
        }


        private static void InvokeAction(Action action, SynchronizationContext invoker)
        {
            if (invoker == null)
            {
                action();
