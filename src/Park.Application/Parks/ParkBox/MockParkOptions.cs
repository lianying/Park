    ...
    public static class MockParkOptions
    {
        public static void MockDevices(this IParkBoxOptions parkBoxOptions)
        {
            List<DeviceInfoDto> deviceInfos = new List<DeviceInfoDto>() {
                    ...
                    new DeviceInfoDto(){  Ip="1.1.1.1", DeviceType= Enum.DeviceType.Camera, Password="123", UserName="123", EquipmentManufacturers= Enum.EquipmentManufacturers.HaiKang, EntranceDto=new Parks.Entrance.EntranceDto(){ EntranceName="出口", EntranceType= Enum.EntranceType.In, Id=2 } }
            };
